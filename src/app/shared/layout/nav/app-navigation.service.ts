...
export class AppNavigationService {
    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Bookstore', null, 'flaticon-home-1', '', [], [
                new AppMenuItem('Authors', null, 'flaticon-users', '/app/main/author'),
                new AppMenuItem('Books', null, 'flaticon-book', '/app/main/book'),
            ]),
